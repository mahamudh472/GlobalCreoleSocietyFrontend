...
export const useMarkAsReadMutation = () => {
  ...
  return useMutation({
    mutationFn: async (notificationIds) => {
      ...
      const response = await apiMethods.post(ENDPOINTS.NOTIFICATIONS.MARK_READ, {
...
export const useDeleteNotificationMutation = () => {
  ...
  return useMutation({
    mutationFn: async (notificationId) => {
      const response = await apiMethods.delete(ENDPOINTS.NOTIFICATIONS.DELETE(notificationId))
